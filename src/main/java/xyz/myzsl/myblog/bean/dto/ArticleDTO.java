package xyz.myzsl.myblog.bean.dto;
...
import xyz.myzsl.myblog.bean.vo.IConverter;
...
public class ArticleDTO {
    ...
    public Article toArticlePO(boolean isUpdate) {
        Article po = new Converter().convertToPO(this);
    ...
    private static class Converter implements IConverter<ArticleDTO, Article> {
        ...
        @Override
        public Article convertToPO(ArticleDTO articleDTO) {
